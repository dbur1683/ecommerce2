...
<th>
 ...
 <td>
 <a class="btn btn-xs btninfo" title="Detail" href="/product/search/{{ $product->id }}">search</a>
 <a class="btn btn-xs btnsuccess" title="Edit" href="/product/edit/{{$product->id }}">update</a>
